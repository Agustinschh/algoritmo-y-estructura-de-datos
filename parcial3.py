...
def obtener_clave(jedi):
    return jedi["name"], jedi["species"]
                              
def buscar_grand_masters(jedis):
    grand_masters = []
    for jedi in jedis:
...
jedis_ordenados = sorted(jedis, key=obtener_clave)


for jedi in jedis_ordenados:
    nombre = jedi['name']
    especie = jedi['species']
    print(f"Nombre: {nombre}, Especie: {especie}")
...
for jedi in jedis:
    if jedi["name"] in ["Ahsoka Tano", "Kit Fisto"]:
        maestro = jedi.get("master", "Desconocido")
        color_sable = jedi.get("lightsaber_color", "Desconocido")
        print(f"Nombre: {jedi['name']}, Maestro: {maestro}, Color de sable: {color_sable}, Especie: {jedi['species']}")
print()


padawans_yoda = []
for jedi in jedis:
    if jedi["master"] is not None and "Yoda" in jedi["master"]:
        padawans_yoda.append(jedi["name"])

print("Padawans de Yoda:", end=" ")
if padawans_yoda:
    print(", ".join(padawans_yoda))
else:
    print("Ninguno")

padawans_luke = []
for jedi in jedis:
    if jedi["master"] is not None and "Luke Skywalker" in jedi["master"]:
        padawans_luke.append(jedi["name"])

print("Padawans de Luke Skywalker:", end=" ")
if padawans_luke:
    print(", ".join(padawans_luke))
else:
    print("Ninguno")
print()
...
for jedi in jedis:
    if jedi["name"].startswith("A"):
        jedis_con_a.append(jedi["name"])

print("Jedi que empiezan con 'A':", end=" ")
if jedis_con_a:
    print(", ".join(jedis_con_a))
else:
    print("Ninguno")
print()
...
for jedi in jedis:
    if jedi["lightsaber_color"] is not None and "/" in jedi["lightsaber_color"]:
        print(f"Nombre: {jedi['name']}, Colores de sable: {jedi['lightsaber_color']}")
print()
...
for jedi in jedis:
    ...
    if lightsaber_color is not None and ("Yellow" in lightsaber_color or "Purple" in lightsaber_color):
        print(f"Nombre: {jedi['name']}, Colores de sable: {lightsaber_color}")
print()   
   

padawans_quigon = []
for jedi in jedis:
    if jedi["master"] is not None and "Qui-Gon Jinn" in jedi["master"]:
        padawans_quigon.append(jedi["name"])

print("Padawans de Qui-Gon Jinn:", end=" ")
if padawans_quigon:
    print(", ".join(padawans_quigon))
else:
    print("Ninguno")

padawans_mace = []
for jedi in jedis:
    if jedi["master"] is not None and isinstance(jedi["master"], str) and "Mace Windu" in jedi["master"]:
        padawans_mace.append(jedi["name"])

print("Padawans de Mace Windu:", end=" ")
if padawans_mace:
    print(", ".join(padawans_mace))
else:
    print("Ninguno")
print()


grand_masters = buscar_grand_masters(jedis)
print("Grand Masters:")
for jedi in grand_masters:
    print(f"Nombre: {jedi['name']}, Rango: {jedi['rank']}")